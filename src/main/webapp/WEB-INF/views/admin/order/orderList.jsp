		...
		<div class="col-9">
			...
			<form name="frm" method="post">
				<div class="input-group" style="margin-bottom: 10px;">
					...
					<input class="btn btn-outline-primary btn-sm"  type="button" value="검색" onClick="go_search()">
					<input class="btn btn-primary" type="button" value="주문처리" onClick="go_order_save()" style="margin-left: 420px;">
				</div>
