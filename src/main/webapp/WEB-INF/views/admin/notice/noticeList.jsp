	...
	<div class="row">
		<div class="col-3" style="margin-top: 54px;">
			...
			<ul class="list-group list-group-flush">
				...
				<li class="list-group-item"><a href="admin_notice_category?kind=1">일반</a></li>
				<li class="list-group-item"><a href="admin_notice_category?kind=2">배송</a></li>
				<li class="list-group-item"><a href="admin_notice_category?kind=3">이벤트</a></li>
				<li class="list-group-item"><a href="admin_notice_category?kind=4">기타</a></li>
			</ul>
		</div>
